...
-- Bài tập 1 : Viết lệnh lấy danh sách nhân viên và thông tin phòng ban
...
-- Bài tập 2 : lấy thông tin account sau ngày 20/12/2010
SELECT * FROM account 
WHERE CreateDate < '2010/12/20' ;


-- Bài tập 3 : Viết lệnh để lấy ra tất cả các developer
SELECT a.AccountID, a.Email, a.FullName, d.PositionName
FROM `account` a
...
-- Bài tập 4 : Viết lệnh để lấy ra danh sách các phòng ban có >3 nhân viên
...
-- Bài tập 5 : Viết lệnh để lấy ra danh sách câu hỏi được sử dụng trong đề thi nhiều nhất
...
-- bai tap 6 Thông kê mỗi category Question được sử dụng trong bao nhiêu Question
...
-- bai tap 7 Thông kê mỗi Question được sử dụng trong bao nhiêu Exam
...
-- bai tap 8 Lấy ra Question có nhiều câu trả lời nhất
...
-- bai tap 9 Thống kê số lượng account trong mỗi group
...
ORDER BY	G.GroupID ASC;
 ...
 -- bai tap 10 Tìm chức vụ có ít người nhất
